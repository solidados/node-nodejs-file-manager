...
import decompressService from "../commands/decompress.service.js";
...
const commands = {
  ...
  'decompress': (filePath, fileDestination) => decompressService(currentDir, filePath, fileDestination).catch(err => console.error(err.message)),
}
